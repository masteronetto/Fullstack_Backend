# Proyecto Kebumy Spring Boot Backend
...
> Puedes registrar nuevos usuarios desde el endpoint `/api/usuarios/registrar` si lo necesitas.
...
- Si tienes Swagger configurado, accede a:
  ...
  - o `http://localhost:8080/swagger-ui/`

### Postman Collection

- Descarga la colección de Postman desde el archivo `API_ENDPOINTS.md` incluido en el repositorio.
- Importa la colección en Postman para probar todos los endpoints disponibles.

---

**Endpoints principales:**
- Autenticación: `/api/auth/login`, `/api/auth/refresh`, `/api/auth/logout`
- Usuarios: `/api/usuarios/registrar`, `/api/usuarios/perfil`
- Carrito: `/api/carrito`, `/api/carrito/agregar`, `/api/carrito/eliminar`
- Pedidos: `/api/pedidos/crear`, `/api/pedidos/usuario/{id}`
- Admin: `/api/pedidos/todos`, `/api/pedidos/{id}/estado`

Para más detalles revisa el archivo `API_ENDPOINTS.md`.

---

> ¿Dudas? Contacta a soporte o revisa la documentación interna del proyecto.
...
1. **✅ Arquitectura en Capas:** Implementación completa con separación clara
2. **✅ API REST:** Endpoints completos con operaciones CRUD
3. **✅ Base de Datos:** Integración con MySQL usando JPA/Hibernate
4. **✅ Validaciones:** Reglas de negocio implementadas en servicios
5. **✅ Manejo de Errores:** Respuestas HTTP apropiadas y logging
6. **✅ Configuración:** CORS y propiedades externalizadas
7. **✅ Documentación:** Código comentado y estructura clara
